function numzero=attempt_for_3Q_alphas_betas(F,G, y , genotype)
...
if no_rows_G>=no_rows_F,
    ...
    a(negix)=-beta(negix) + 1;
    aa((beta<=0))= 1;
    
    a(posix)=1;
    aa(posix)=beta(posix)+1;
